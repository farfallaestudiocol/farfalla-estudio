-- Create product relationships table for manual cross-selling
CREATE TABLE public.product_relationships (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  product_id UUID NOT NULL,
  related_product_id UUID NOT NULL,
  relationship_type TEXT NOT NULL DEFAULT 'related', -- 'related', 'complementary', 'upsell'
  strength INTEGER NOT NULL DEFAULT 1, -- 1-10 strength of relationship
...
-- Create function to get products frequently bought together
